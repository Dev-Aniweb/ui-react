...
const App = () => {
  ...
  const users = [
    ...
    },
    {
     ...
     {
      img: 'https://plus.unsplash.com/premium_photo-1666264200711-9a06dbfb0fea?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      intro: '',
      tag: 'Underbjsj',
